...
namespace BizTalk.Adapter.SBQueue
{
	...
	{
        public static ConcurrentDictionary<string, QueueClient> clients = new ConcurrentDictionary<string, QueueClient>();
			...
			typeof(SBQueueReceiverEndpoint))
		{
            ...
            if(clients == null)
                clients = new ConcurrentDictionary<string, QueueClient>();
